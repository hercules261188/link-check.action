...
let b,w={type:"root",input:e,nodes:[]},R=[w],x=w,A=w,E=0,k=e.length,C=0,S=0
const T=()=>e[C++],O=e=>{if("text"===e.type&&"dot"===A.type&&(A.type="text"),!A||"text"!==A.type||"text"!==e.type)return x.nodes.push(e),e.parent=x,e.prev=A,A=e,e
A.value+=e.value}
for(O({type:"bos"});C<k;)if(x=R[R.length-1],b=T(),b!==g&&b!==v)if(b!==s)if(b!==f)if(b!==d)if(b!==l)if(b!==c)if(b!==_&&b!==y&&b!==o)if(b!==h)if(b!==p)if(b===a&&S>0){if(x.ranges>0){x.ranges=0
let e=x.nodes.shift()
...
for(!0!==t.keepQuotes&&(b="");C<k&&(e=T());)if(e!==s){if(e===n){!0===t.keepQuotes&&(b+=e)
...
let e
for(;C<k&&(e=T());)if(b+=e,e!==d)if(e!==s){if(e===f&&(E--,0===E))break}else b+=T()
else E++
...
const f={type:"bos",value:"",output:n.prepend||""},_=[f],y=n.capture?"":"?:",v=i.isWindows(t),g=r.globChars(v),m=r.extglobChars(g),{DOT_LITERAL:b,PLUS_LITERAL:w,SLASH_LITERAL:R,ONE_CHAR:x,DOTS_SLASH:A,NO_DOT:E,NO_DOT_SLASH:k,NO_DOTS_SLASH:C,QMARK:S,QMARK_NO_DOT:T,STAR:O,START_ANCHOR:P}=g,I=e=>`(${y}(?:(?!${P}${e.dot?A:b}).)*?)`,L=n.dot?"":E,H=n.dot?S:T
let $=!0===n.bash?I(n):O
...
let k,C,S=e,T=-1,O=0,P=0,I=!1,L=!1,H=!1,$=!1,j=!1,N=!1,q=!1,B=!1,D=!1,G=0,M={value:"",depth:0,isGlob:!1}
const U=()=>T>=w,K=()=>(k=C,S.charCodeAt(++T))
for(;T<w;){let e
...
continue}break}}if(C===i){if(k===i&&(j=M.isGlobstar=!0),H=M.isGlob=!0,D=!0,!0===R)continue
...
if(!0===n.tokens&&(Q.maxDepth=0,m(C)||A.push(M),Q.tokens=A),!0===n.parts||!0===n.tokens){let t
...
const x=u().Readable,A=Symbol("buffer"),E=Symbol("type")
...
return a[A]=o,a}}function C(e,t,n){Error.call(this,e),this.message=e,this.type=t,n&&(this.code=this.errno=n.code),Error.captureStackTrace(this,this.constructor)}let S
Object.defineProperties(k.prototype,{size:{enumerable:!0},type:{enumerable:!0},slice:{enumerable:!0}}),Object.defineProperty(k.prototype,Symbol.toStringTag,{value:"Blob",writable:!1,enumerable:!1,configurable:!0}),C.prototype=Object.create(Error.prototype),C.prototype.constructor=C,C.prototype.name="FetchError"
...
break}i[2]&&o.ops.pop(),o.trys.pop()
continue}s=t.call(e,o)}catch(e){s=[6,e],r=0}finally{n=i=0}if(5&s[0])throw s[1]
return{value:s[0]?s[1]:void 0,done:!0}}([s,a])}}},Ae=function(e,t){var n=e.filePath,r=e.content,i=t.rootURL,s=t.linkIncludePatterns,o=t.linkExcludePatterns
...
case 2:return t=a.sent().filter(Boolean),[2,{filePath:n,checks:t}]}}))}))},Ee=function(e,t){return Re(void 0,void 0,void 0,(function(){var r,i,s,o,a
return xe(this,(function(u){switch(u.label){case 0:return r=t.maxConcurrent,i=void 0===r?1:r,s=t.minTime,o=void 0===s?333:s,a=new(n())({maxConcurrent:i,minTime:o}),[4,be(e,(function(e){return Ae(e,we(we({},t),{limiter:a}))}))]
case 1:return[2,u.sent().filter(Boolean)]}}))}))},ke=function(e){var t=e.checks,n=e.filePath
return"* "+(t.some((function(e){return!e.pass}))?"FAIL":"PASS")+": "+n+"\n"},Ce=function(e){var t=e.link,n=e.href,r=e.description
return"  - "+(e.pass?"PASS":"FAIL")+": "+t+(n?" = "+n:"")+" ("+r+")"},Se=function(e,t){var n=e.filePath,r=e.checks,i=t.fileFormat,s=void 0===i?ke:i,o=t.linkFormat,a=void 0===o?Ce:o,u=t.linkSeparator,l=void 0===u?"\n":u
...
return Ne(this,(function(A){switch(A.label){case 0:return t=new Promise((function(t,n){(0,e.exec)("git fetch origin master",(function(e){return e?n(e):t()}))})),[4,be(["rootURL","linkIncludePatternFiles","linkIncludePatterns","linkExcludePatternFiles","linkExcludePatterns","fileIncludePatternFiles","fileIncludePatterns","fileExcludePatternFiles","fileExcludePatterns"],qe)]
case 1:return n=A.sent(),r=n[0],i=n[1],s=n[2],o=n[3],a=n[4],u=n[5],c=n[6],h=n[7],p=n[8],[4,$e([[i,s],[o,a],[u,c],[h,p]])]
case 2:return d=A.sent(),f=d[0],_=d[1],v=d[2],g=d[3],m={source:"git-diff",rootURL:r,linkIncludePatterns:Ie(f),linkExcludePatterns:_,fileIncludePatterns:Ie(v),fileExcludePatterns:g},[4,t]
case 3:return A.sent(),[4,y()]
case 4:return b=A.sent(),[4,Ee(b,m)]
case 5:return 0===(w=A.sent()).length?(l.setOutput("output",JSON.stringify({summary:"There were no files to check links in."})),l.setOutput("conclusion","success")):(R="# Link check report\n\n"+Te(w,{linkFormat:function(e){var t=e.link,n=e.href,r=e.description
