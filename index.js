...
let b,w={type:"root",input:e,nodes:[]},k=[w],S=w,x=w,E=0,A=e.length,R=0,O=0
const P=()=>e[R++],C=e=>{if("text"===e.type&&"dot"===x.type&&(x.type="text"),!x||"text"!==x.type||"text"!==e.type)return S.nodes.push(e),e.parent=S,e.prev=x,x=e,e
x.value+=e.value}
for(C({type:"bos"});R<A;)if(S=k[k.length-1],b=P(),b!==v&&b!==g)if(b!==s)if(b!==f)if(b!==d)if(b!==c)if(b!==l)if(b!==_&&b!==y&&b!==o)if(b!==h)if(b!==p)if(b===a&&O>0){if(S.ranges>0){S.ranges=0
let e=S.nodes.shift()
S.nodes=[e,{type:"text",value:r(S)}]}C({type:"comma",value:b}),S.commas++}else if(b===u&&O>0&&0===S.commas){let e=S.nodes
if(0===O||0===e.length){C({type:"text",value:b})
continue}if("dot"===x.type){if(S.range=[],x.value+=b,x.type="range",3!==S.nodes.length&&5!==S.nodes.length){S.invalid=!0,S.ranges=0,x.type="text"
continue}S.ranges++,S.args=[]
continue}if("range"===x.type){e.pop()
let t=e[e.length-1]
t.value+=x.value+b,x=t,S.ranges--
continue}C({type:"dot",value:b})}else C({type:"text",value:b})
else{if("brace"!==S.type){C({type:"text",value:b})
continue}let e="close"
S=k.pop(),S.close=!0,C({type:e,value:b}),O--,S=k[k.length-1]}else{O++
let e=x.value&&"$"===x.value.slice(-1)||!0===S.dollar
S=C({type:"brace",open:!0,close:!1,dollar:e,depth:O,commas:0,ranges:0,nodes:[]}),k.push(S),C({type:"open",value:b})}else{let e,n=b
for(!0!==t.keepQuotes&&(b="");R<A&&(e=P());)if(e!==s){if(e===n){!0===t.keepQuotes&&(b+=e)
break}b+=e}else b+=e+P()
C({type:"text",value:b})}else{if("paren"!==S.type){C({type:"text",value:b})
continue}S=k.pop(),C({type:"text",value:b}),S=k[k.length-1]}else S=C({type:"paren",nodes:[]}),k.push(S),C({type:"text",value:b})
else{E++
let e
...
do{if(S=k.pop(),"root"!==S.type){S.nodes.forEach(e=>{e.nodes||("open"===e.type&&(e.isOpen=!0),"close"===e.type&&(e.isClose=!0),e.nodes||(e.type="text"),e.invalid=!0)})
let e=k[k.length-1],t=e.nodes.indexOf(S)
e.nodes.splice(t,1,...S.nodes)}}while(k.length>0)
...
let b={negatives:[],positives:[]},w=[],k=0
for(;o?i>=s:i<=s;)!0===r.toRegex&&n>1?b[(S=i)<0?"negatives":"positives"].push(Math.abs(S)):w.push(c(m(i,k),g,v)),i=o?i-n:i+n,k++
var S
...
const f={type:"bos",value:"",output:n.prepend||""},_=[f],y=n.capture?"":"?:",g=i.isWindows(t),v=r.globChars(g),m=r.extglobChars(v),{DOT_LITERAL:b,PLUS_LITERAL:w,SLASH_LITERAL:k,ONE_CHAR:S,DOTS_SLASH:x,NO_DOT:E,NO_DOT_SLASH:A,NO_DOTS_SLASH:R,QMARK:O,QMARK_NO_DOT:P,STAR:C,START_ANCHOR:T}=v,j=e=>`(${y}(?:(?!${T}${e.dot?x:b}).)*?)`,L=n.dot?"":E,I=n.dot?O:P
...
Q("parens"),X({type:e,value:t,output:D.output?"":S}),X({type:"paren",extglob:!0,value:U(),output:i}),F.push(r)},J=e=>{let t=e.close+(n.capture?")":"")
...
if(r){B.value=t+r,D.backtrack=!0,U(),f.output||1!==_.indexOf(B)||(f.output=S)
...
continue}X({type:"slash",value:N,output:k})
...
D.output=D.output.slice(0,-(r.output+B.output).length),r.output="(?:"+r.output,B.type="globstar",B.output=`${j(n)}${k}|${k}${e})`,B.value+=N,D.output+=r.output+B.output,D.globstar=!0,V(N+U()),X({type:"slash",value:"/",output:""})
continue}if("bos"===r.type&&"/"===t[0]){B.type="globstar",B.value+=N,B.output=`(?:^|${k}|${j(n)}${k})`,D.output=B.output,D.globstar=!0,V(N+U()),X({type:"slash",value:"/",output:""})
...
!0!==n.bash?!B||"bracket"!==B.type&&"paren"!==B.type||!0!==n.regex?(D.index!==D.start&&"slash"!==B.type&&"dot"!==B.type||("dot"===B.type?(D.output+=A,B.output+=A):!0===n.dot?(D.output+=R,B.output+=R):(D.output+=L,B.output+=L),"*"!==G()&&(D.output+=S,B.output+=S)),X(r)):(r.output=N,X(r)):(r.output=".*?","bos"!==B.type&&"slash"!==B.type||(r.output=L+r.output),X(r))}for(;D.brackets>0;){if(!0===n.strictBrackets)throw new SyntaxError(h("closing","]"))
...
D.output=i.escapeLast(D.output,"{"),Y("braces")}if(!0===n.strictSlashes||"star"!==B.type&&"bracket"!==B.type||X({type:"maybe_slash",value:"",output:k+"?"}),!0===D.backtrack){D.output=""
...
let k=!0===n.bash?".*?":g
n.capture&&(k=`(${k})`)
const S=e=>!0===e.noglobstar?k:`(${w}(?:(?!${v}${e.dot?d:l}).)*?)`,x=e=>{switch(e){case"*":return`${m}${p}${k}`
case".*":return`${l}${p}${k}`
case"*.*":return`${m}${k}${l}${p}${k}`
case"*/*":return`${m}${k}${h}${p}${b}${k}`
case"**":return m+S(n)
case"**/*":return`(?:${m}${S(n)}${h})?${b}${p}${k}`
case"**/*.*":return`(?:${m}${S(n)}${h})?${b}${k}${l}${p}${k}`
case"**/.*":return`(?:${m}${S(n)}${h})?${l}${p}${k}`
...
e.exports=(e,t)=>{const n=t||{},w=e.length-1,k=!0===n.parts||!0===n.scanToEnd,S=[],x=[],E=[]
let A,R,O=e,P=-1,C=0,T=0,j=!1,L=!1,I=!1,H=!1,D=!1,F=!1,M=!1,$=!1,N=!1,B=0,q={value:"",depth:0,isGlob:!1}
const G=()=>P>=w,U=()=>(A=R,O.charCodeAt(++P))
for(;P<w;){let e
if(R=U(),R!==o){if(!0===F||R===h){for(B++;!0!==G()&&(R=U());)if(R!==o)if(R!==h){if(!0!==F&&R===u&&(R=U())===u){if(j=q.isBrace=!0,I=q.isGlob=!0,N=!0,!0===k)continue
break}if(!0!==F&&R===a){if(j=q.isBrace=!0,I=q.isGlob=!0,N=!0,!0===k)continue
break}if(R===y&&(B--,0===B)){F=!1,j=q.isBrace=!0,N=!0
break}}else B++
else M=q.backslashes=!0,U()
if(!0===k)continue
break}if(R!==l){if(!0!==n.noext){if(!0===(R===f||R===s||R===i||R===_||R===c)&&O.charCodeAt(P+1)===p){if(I=q.isGlob=!0,H=q.isExtglob=!0,N=!0,!0===k){for(;!0!==G()&&(R=U());)if(R!==o){if(R===g){I=q.isGlob=!0,N=!0
break}}else M=q.backslashes=!0,R=U()
continue}break}}if(R===i){if(A===i&&(D=q.isGlobstar=!0),I=q.isGlob=!0,N=!0,!0===k)continue
break}if(R===_){if(I=q.isGlob=!0,N=!0,!0===k)continue
break}if(R===d)for(;!0!==G()&&(e=U());)if(e!==o){if(e===v){if(L=q.isBracket=!0,I=q.isGlob=!0,N=!0,!0===k)continue
break}}else M=q.backslashes=!0,U()
if(!0===n.nonegate||R!==c||P!==C){if(!0!==n.noparen&&R===p){if(I=q.isGlob=!0,!0===k){for(;!0!==G()&&(R=U());)if(R!==p){if(R===g){N=!0
break}}else M=q.backslashes=!0,R=U()
continue}break}if(!0===I){if(N=!0,!0===k)continue
break}}else $=q.negated=!0,C++}else{if(S.push(P),x.push(q),q={value:"",depth:0,isGlob:!1},!0===N)continue
if(A===u&&P===C+1){C+=2
...
for(let r=0;r<S.length;r++){const i=t?t+1:C,s=S[r],o=e.slice(i,s)
...
E.push(r),n.tokens&&(x[x.length-1].value=r,b(x[x.length-1]),z.maxDepth+=x[x.length-1].depth)}z.slashes=S,z.parts=E}return z}},3337:(e,t,n)=>{"use strict"
...
return b(this,(function(r){switch(r.label){case 0:return[4,s()(t,{ignore:n})]
...
continue}s=t.call(e,o)}catch(e){s=[6,e],r=0}finally{n=i=0}if(5&s[0])throw s[1]
return{value:s[0]?s[1]:void 0,done:!0}}([s,a])}}}
const x=function(e){return k(this,void 0,void 0,(function(){var t
return S(this,(function(n){switch(t=e.source){case void 0:case"git-diff":return[2,v(e)]
case"filesystem":return[2,w(e)]
default:throw new Error('link-check was provided unexpected source "'+t+'"!')}return[2]}))}))}
var E=__webpack_require__(5406),A=__webpack_require__.n(E),R=__webpack_require__(8835),O=__webpack_require__.n(R),P=__webpack_require__(7211),C=__webpack_require__.n(P),T=__webpack_require__(8761),j=__webpack_require__.n(T)
const L=c().Readable,I=Symbol("buffer"),H=Symbol("type")
...
throw e.code="MODULE_NOT_FOUND",e}()).convert}catch(e){}const $=Symbol("Body internals"),N=c().PassThrough
function B(e){var t=this,n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=n.size
let i=void 0===r?0:r
var s=n.timeout
let o=void 0===s?0:s
null==e?e=null:G(e)?e=Buffer.from(e.toString()):U(e)||Buffer.isBuffer(e)||("[object ArrayBuffer]"===Object.prototype.toString.call(e)?e=Buffer.from(e):ArrayBuffer.isView(e)?e=Buffer.from(e.buffer,e.byteOffset,e.byteLength):e instanceof c()||(e=Buffer.from(String(e)))),this[$]={body:e,disturbed:!1,error:null},this.size=i,this.timeout=o,e instanceof c()&&e.on("error",(function(e){const n="AbortError"===e.name?e:new F(`Invalid response body while trying to fetch ${t.url}: ${e.message}`,"system",e)
...
if(!(t instanceof c()))return B.Promise.resolve(Buffer.alloc(0))
let n=[],r=0,i=!1
...
const ce=Symbol("Request internals"),le=O().parse,he=O().format,pe="destroy"in c().Readable.prototype
...
const ye=c().PassThrough,ge=O().resolve
...
if(e.signal&&e.body instanceof c().Readable&&!pe)throw new Error("Cancellation of streamed requests with AbortSignal is not supported in node < 8")
let r=null
...
r(e),i.body&&i.body instanceof c().Readable&&i.body.destroy(e),u&&u.body&&u.body.emit("error",e)}
...
if(!i.compress||"HEAD"===i.method||null===c||204===e.statusCode||304===e.statusCode)return u=new ue(s,o),void n(u)
const l={flush:j().Z_SYNC_FLUSH,finishFlush:j().Z_SYNC_FLUSH}
if("gzip"==c||"x-gzip"==c)return s=s.pipe(j().createGunzip(l)),u=new ue(s,o),void n(u)
if("deflate"!=c&&"x-deflate"!=c){if("br"==c&&"function"==typeof j().createBrotliDecompress)return s=s.pipe(j().createBrotliDecompress()),u=new ue(s,o),void n(u)
u=new ue(s,o),n(u)}else{e.pipe(new ye).once("data",(function(e){s=8==(15&e[0])?s.pipe(j().createInflate()):s.pipe(j().createInflateRaw()),u=new ue(s,o),n(u)}))}})),function(e,t){const n=t.body
...
for(r=Object.getOwnPropertySymbols(e);i<r.length;i++)t.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(e,r[i])&&(n[r[i]]=e[r[i]])}return n},xe={},Ee=function(e,t){if(!xe[e]){var n=Object.entries(t.bottlenecks).find((function(t){var n=t[0]
return d().isMatch(e,n)})),r=n?n[1]:{},i=r.minTime,s=void 0===i?400:i,o=r.maxConcurrent,a=void 0===o?1:o
xe[e]=new(A())({minTime:s,maxConcurrent:a})}return xe[e]},Ae=function(e,t,n){return we(void 0,void 0,void 0,(function(){return ke(this,(function(r){return[2,Ee(e.hostname,n).schedule((function(){return me(e.href,t)}))]}))}))},Re=function(e,t,n){return void 0===t&&(t={}),we(void 0,void 0,void 0,(function(){var r,i,s
return ke(this,(function(o){switch(o.label){case 0:return[4,Ae(e,be(be({},t),{method:"HEAD"}),n)]
case 1:return 405===(r=o.sent()).status?[2,Ae(e,be(be({},t),{method:"GET"}),n)]:429===r.status&&(i=r.headers.get("retry-after"))?(s=1e3*Number(i),[2,new Promise((function(r){setTimeout((function(){return we(void 0,void 0,void 0,(function(){var i
return ke(this,(function(s){switch(s.label){case 0:return i=r,[4,Re(e,t,n)]
...
s&&r.push(s),i=t.exec(e)}return r},Le=function(e,t){switch(a().extname(e)){case".md":case".mdx":var n=je(t,/\[.*?\]\((?:<((?:\(.*?\)|.)*?)>|((?:\(.*?\)|.)*?))(?: ["'].*?["'])?\)/gm,(function(e){return e[2]||e[1]})),r=je(t,/href="(.*?)"/gm),i=n.concat(r)
...
break}i[2]&&o.ops.pop(),o.trys.pop()
continue}s=t.call(e,o)}catch(e){s=[6,e],r=0}finally{n=i=0}if(5&s[0])throw s[1]
return{value:s[0]?s[1]:void 0,done:!0}}([s,a])}}},Ne=function(){for(var e=0,t=0,n=arguments.length;t<n;t++)e+=arguments[t].length
var r=Array(e),i=0
for(t=0;t<n;t++)for(var s=arguments[t],o=0,a=s.length;o<a;o++,i++)r[i]=s[o]
return r},Be=function(e,t){var n=e.filePath,r=e.content
...
function qe(e,t){return Me(this,void 0,void 0,(function(){var n,r,i,s,o
return $e(this,(function(a){switch(a.label){case 0:return[4,Fe(e,(function(e){return Be(e,t)}))]
...
return[n+o.length,r+a.length,a.length>0?Ne(i,[{filePath:s,checks:a}]):i]}),[0,0,[]]),i=r[0],s=r[1],o=r[2],[2,{entries:n,failedEntries:o,totalChecksCount:i,failedChecksCount:s,unusedPatterns:(u=t.linkExcludePatterns,u?u.filter((function(e){return!Ce.has(e)})):[])}]}var u}))}))}const Ge=function(e,t,n){var r=t.output,i=Array.isArray(r)?r:[r]
e.forEach((function(e){var r=e.name,s=e.reporter
i.includes(r)&&s(n,t)}))}
var Ue=function(){return(Ue=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++)for(var i in t=arguments[n])Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])
return e}).apply(this,arguments)},Ke=function(e){return"* "+e.filePath+"\n"},Ve=function(e){var t=e.link,n=e.href,r=e.description
return"  - "+(e.pass?"PASS":"FAIL")+": "+t+(n?" = "+n:"")+" ("+r+")"},We=function(e,t){var n=e.filePath,r=e.checks,i=t.fileFormat,s=void 0===i?Ke:i,o=t.linkFormat,a=void 0===o?Ve:o,u=t.linkSeparator,c=void 0===u?"\n":u
return r.length>0?s({filePath:n,checks:r})+r.map(a).join(c):null},ze=function(e,t){return We(e,Ue({linkFormat:function(e){var t=e.link,n=e.href
return"  - "+t+(n?" = "+n:"")+" ("+e.description+")"},fileFormat:function(e){return"* "+e.filePath+"\n"}},t))}
const Qe=function(e,t){void 0===t&&(t={})
var n=t.entryFormat,r=void 0===n?t.failsOnly?ze:We:n,i=t.entrySeparator,s=void 0===i?"\n\n":i
return e.map((function(e,n){return r(e,t,n)})).filter(Boolean).join(s)}
function Ye(e,t){return void 0===t&&(t="\n\n"),e&&e.length>0?e.filter(Boolean).join(t):void 0}function Xe(e){console.log(Ye(e))}function Ze(t){var n=t.success,r=t.conclusion,i=void 0===r?n?"success":"failure":r,s=t.summarySegments,o=t.descriptionSegments,a=t.summary,u=void 0===a?Ye(s,", "):a,c=t.description,l=void 0===c?Ye(o,"\n\n"):c
e.setOutput("conclusion",i)
var h={summary:u}
l&&(h.text_description=l),e.setOutput("output",JSON.stringify(h))}var Je=function(e){return"* "+e.filePath+"\n"},et=function(e){var t=e.link,n=e.href,r=e.description
return"  - "+(e.pass?":heavy_check_mark:":":x:")+" "+t+(n&&n!==t?" = "+n:"")+" ("+r+")"},tt=function(e){var t=e.link,n=e.href
return"  - "+t+(n&&n!==t?" = "+n:"")+" ("+e.description+")"}
var nt=function(){return(nt=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++)for(var i in t=arguments[n])Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])
return e}).apply(this,arguments)},rt=function(e,t,n,r){return new(n||(n=Promise))((function(i,s){function o(e){try{u(r.next(e))}catch(e){s(e)}}function a(e){try{u(r.throw(e))}catch(e){s(e)}}function u(e){var t
e.done?i(e.value):(t=e.value,t instanceof n?t:new n((function(e){e(t)}))).then(o,a)}u((r=r.apply(e,t||[])).next())}))},it=function(e,t){var n,r,i,s,o={label:0,sent:function(){if(1&i[0])throw i[1]
return i[1]},trys:[],ops:[]}
return s={next:a(0),throw:a(1),return:a(2)},"function"==typeof Symbol&&(s[Symbol.iterator]=function(){return this}),s
function a(s){return function(a){return function(s){if(n)throw new TypeError("Generator is already executing.")
for(;o;)try{if(n=1,r&&(i=2&s[0]?r.return:s[0]?r.throw||((i=r.return)&&i.call(r),0):r.next)&&!(i=i.call(r,s[1])).done)return i
...
break}i[2]&&o.ops.pop(),o.trys.pop()
continue}s=t.call(e,o)}catch(e){s=[6,e],r=0}finally{n=i=0}if(5&s[0])throw s[1]
return{value:s[0]?s[1]:void 0,done:!0}}([s,a])}}},st=function(e,t){var n={}
for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&t.indexOf(r)<0&&(n[r]=e[r])
if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var i=0
for(r=Object.getOwnPropertySymbols(e);i<r.length;i++)t.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(e,r[i])&&(n[r[i]]=e[r[i]])}return n},ot=function(){for(var e=0,t=0,n=arguments.length;t<n;t++)e+=arguments[t].length
var r=Array(e),i=0
for(t=0;t<n;t++)for(var s=arguments[t],o=0,a=s.length;o<a;o++,i++)r[i]=s[o]
return r},at=function(e){if(e){if(!Array.isArray(e))return e
if(e.length>0)return e}return"**"}
function ut(e){return rt(this,void 0,void 0,(function(){return it(this,(function(t){return[2,new Promise((function(t,n){return h().readFile(e,(function(e,r){return e?n(e):t(String(r).split(/\n+/))}))}))]}))}))}function ct(e){return rt(this,void 0,void 0,(function(){var t,n,r,i,s
return it(this,(function(o){switch(o.label){case 0:return e?Array.isArray(e)?(r=(n=(s=[]).concat).apply,i=[s],[4,Fe(e,ut)]):[3,2]:[2,[]]
case 1:return t=r.apply(n,i.concat([o.sent()])),[3,3]
case 2:t=ut(e),o.label=3
case 3:return[2,t]}}))}))}function lt(e){return rt(this,void 0,void 0,(function(){var t=this
return it(this,(function(n){return[2,Fe(e,(function(e){var n=e[0],r=e[1]
return rt(t,void 0,void 0,(function(){var e
return it(this,(function(t){switch(t.label){case 0:return[4,ct(n)]
case 1:return e=t.sent(),[2,(r?e.concat(r):e).filter(Boolean)]}}))}))}))]}))}))}function ht(e){return rt(this,void 0,void 0,(function(){var t,r,i,s,o,a,u,c,l,h,p,d,f,_,y,g,v,m,b,w,k,S,x
return it(this,(function(E){switch(E.label){case 0:return t=n().apply(void 0,ot([{}],e.filter(Boolean))),r=t.fileIncludePatterns,i=t.fileExcludePatterns,s=t.fileIncludePatternFiles,o=t.fileExcludePatternFiles,a=t.linkIncludePatterns,u=t.linkExcludePatterns,c=t.linkIncludePatternFiles,l=t.linkExcludePatternFiles,h=t.reportUnusedPatterns,p=t.dryRun,d=void 0===p?"only"===h:p,f=t.failOnUnusedPatterns,_=void 0===f?"only"===h:f,y=t.bottlenecks,g=void 0===y?{}:y,v=t.output,m=st(t,["fileIncludePatterns","fileExcludePatterns","fileIncludePatternFiles","fileExcludePatternFiles","linkIncludePatterns","linkExcludePatterns","linkIncludePatternFiles","linkExcludePatternFiles","reportUnusedPatterns","dryRun","failOnUnusedPatterns","bottlenecks","output"]),[4,lt([[c,a],[l,u],[s,r],[o,i]])]
case 1:return b=E.sent(),w=b[0],k=b[1],S=b[2],x=b[3],[2,nt(nt({},m),{bottlenecks:g,reportUnusedPatterns:h,dryRun:d,output:v&&(Array.isArray(v)?v:[v]),failOnUnusedPatterns:_,linkIncludePatterns:at(w),linkExcludePatterns:k,fileIncludePatterns:at(S),fileExcludePatterns:x})]}}))}))}var pt=function(){return(pt=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++)for(var i in t=arguments[n])Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])
...
break}i[2]&&o.ops.pop(),o.trys.pop()
continue}s=t.call(e,o)}catch(e){s=[6,e],r=0}finally{n=i=0}if(5&s[0])throw s[1]
return{value:s[0]?s[1]:void 0,done:!0}}([s,a])}}},_t=function(e,t){var n={}
for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&t.indexOf(r)<0&&(n[r]=e[r])
if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var i=0
...
var r=Array(e),i=0
for(t=0;t<n;t++)for(var s=arguments[t],o=0,a=s.length;o<a;o++,i++)r[i]=s[o]
return r},gt=[{name:"checkAction",reporter:function(e,t){var n=e.totalChecksCount,r=e.failedChecksCount,i=e.entries,s=e.failedEntries,o=e.unusedPatterns,a=t.reportUnusedPatterns,u=t.failsOnly,c=[],l=[],h=u?s:i,p={fileFormat:Je,linkFormat:u?tt:et}
if(0===n)return Ze({summary:"There were no files to check links in.",success:!0})
if(0===r)return Ze({summary:"All links passed the check!",success:!0})
if(a&&o.length>0){var d=o.map((function(e){return"  - "+e})).join("\n\n")
if(c.push("Some link patterns were unused"),l.push("# Unused link exclusion patterns",d),"only"===a)return Ze({summarySegments:c,descriptionSegments:l,success:!1})}var f=r>0,_=u?"# Failed Link Checks":"# Link Checks"
return f?(c.push("Some new links failed the check."),l.push(_,Qe(h,p))):(c.push("All new links passed the check!"),u||l.push(_,Qe(h,p))),Ze({summarySegments:c,descriptionSegments:l,success:!f})}},{name:"consoleLog",reporter:function(e,t){var n=t.reportUnusedPatterns,r=t.failsOnly,i=e.totalChecksCount,s=e.failedChecksCount,o=e.entries,a=e.failedEntries,u=e.unusedPatterns,c=[],l=r?a:o
...
function vt(){return dt(this,void 0,void 0,(function(){var t,n,r,i,s,o,u,c
return ft(this,(function(l){switch(l.label){case 0:return t=Object.fromEntries(["source","configFile","rootURL","dryRun","reportUnusedPatterns","linkIncludePatternFiles","linkIncludePatterns","linkExcludePatternFiles","linkExcludePatterns","fileIncludePatternFiles","fileIncludePatterns","fileExcludePatternFiles","fileExcludePatterns","output","failsOnly"].reduce((function(t,n){var r=function(t){var n=e.getInput(t)
try{return JSON.parse(n)}catch(e){if(e instanceof SyntaxError)return n
throw e}}(n)
return""===r?t:yt(t,[[n,r]])}),[])),n=t.configFile,r=t.output,i=void 0===r?["consoleLog","exitCode"]:r,s=t.failsOnly,o=_t(t,["configFile","output","failsOnly"]),u=ht,c=[pt(pt({},o),{output:i,failsOnly:"false"!==s})],[4,(p=n,rt(void 0,void 0,void 0,(function(){return it(this,(function(e){return p?[2,JSON.parse(String(h().readFileSync(a().join(process.cwd(),p))))]:[2,{}]}))})))]
case 1:return[2,u.apply(void 0,[c.concat([l.sent()])])]}var p}))}))}!function(){dt(this,void 0,void 0,(function(){var e,t,n
return ft(this,(function(i){switch(i.label){case 0:return e=new Promise((function(e,t){(0,r.exec)("git fetch origin master",(function(n){return n?t(n):e()}))})),[4,vt()]
case 1:return t=i.sent(),console.log("Options:",t),[4,e]
case 2:return i.sent(),[4,x(t)]
case 3:return[4,qe(i.sent(),t)]
case 4:return n=i.sent(),Ge(gt,t,n),[2]}}))}))}()})()})()
